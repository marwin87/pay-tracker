...
|---|------------|-----------------|---------------|------------|--------|---------------|
| 1 | Recurrence unit tests | Prove period math and next-instance generation are correct at all boundary cases | #1, #2 | unit | change opened | context/changes/testing-recurrence-unit/ |
| 2 | PostgreSQL integration baseline | Replace SQLite fixture with real PostgreSQL; add per-endpoint IDOR integration tests | #3, #4 | integration | not started | — |
